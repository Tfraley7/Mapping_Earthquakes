...
// Looping through our intervals to generate a label with a colored square for each interval.
  ...
  d3.json("https://raw.githubusercontent.com/fraxen/tectonicplates/master/GeoJSON/PB2002_boundaries.json").then(function(data) {
    //Pass data to the tectonicPlates layer using linse string retunrned from the d3.json
    L.geoJson(data, {
      pointToLayer: function(feature, plateBoundary) {
        console.log(data);
        return L.polyLine(plateBoundary);
      },
      style: {
        color: "purple",
        weight: 2
